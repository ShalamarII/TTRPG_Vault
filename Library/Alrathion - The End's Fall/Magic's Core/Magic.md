...
### Fatigue Replacement
This is to replace the effects of using FP for casting. (Allows you to mitigate the FP Count)
...
# How to cast a spell
1. Choose a Verb and a Noun
2. Cost: Take the costs of the Verb and Noun (for FP use the Realm Level)
3. Duration: Use duration table
